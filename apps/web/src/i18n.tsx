...
const EN = {
  ...
  "pricing.errandsBlurb": "Short and specific: one thing fetched, one errand run. Priced for a quick job, at a spend cap you set — no ceiling at all on an errand — and included on every plan, Free too.",
...
const ES: Record<TranslationKey, string> = {
  ...
  "pricing.errandsBlurb": "Corto y específico: recoger una cosa, hacer un encargo. Con precio de trabajo rápido y el límite de gasto que tú fijes — un encargo no tiene techo alguno — e incluido en todos los planes, también en el gratuito.",
