...
const EN = {
  ...
  "pricing.errandsBlurb": "Short and specific: one thing fetched, one errand run. Priced for a quick job, and capped at $50 of spend so \"quick\" stays quick.",
...
const ES: Record<TranslationKey, string> = {
  ...
  "pricing.errandsBlurb": "Corto y específico: recoger una cosa, hacer un encargo. Con precio de trabajo rápido y un límite de $50 de gasto para que \"rápido\" siga siendo rápido.",
